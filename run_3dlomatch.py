...
# ==============================================================================
def parse_args():
    parser = argparse.ArgumentParser(description="Run GeoRescue Full Model on 3DLoMatch.")
    parser.add_argument("--pcd_base_dir", type=str, required=True, help="点云根目录")
    parser.add_argument("--benchmark_pkl", type=str, required=True, help="3DLoMatch.pkl 路径")
    parser.add_argument("--output_dir", type=str, default="3dlomatch_results", help="结果输出目录")
...
def run_pipeline(src_pcd, tgt_pcd):
    ...
    # 2. 初始匹配（Full 模型中 reciprocal=False）
...
def main():
    print("=" * 80)
    print("GeoRescue Full Evaluation on 3DLoMatch")
    print("=" * 80)
